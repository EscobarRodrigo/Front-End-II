...
// Aspas duplas " " no JSON é utilizado para identificar/definir os valores > exemplo: "nome"
//Aspas simpes ' ' é utilizado *por fora* '{"nome:"Willian"}' > quando utilizado dentro do JS..se for um arquivo JSON, não preciso das aspas simples.
...
objetoLiteral.nome = "Willian Sant Ana" // atualizando o nome
objetoLiteral.sobrenome = "Sant Anna"
...
objetoLiteral.nomeCompleto('Willian','Sant Anna');
